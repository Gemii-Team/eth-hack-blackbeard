...
hoistedDependencies:
  ...
  /@angular-devkit/schematics-cli/19.1.2(@types/node@22.12.0)(chokidar@4.0.3):
  ...
  /@inquirer/checkbox/4.0.7(@types/node@22.12.0):
  ...
  /@inquirer/editor/4.2.4(@types/node@22.12.0):
    '@inquirer/editor': private
  /@inquirer/expand/4.0.7(@types/node@22.12.0):
    '@inquirer/expand': private
  /@inquirer/figures/1.0.10:
    '@inquirer/figures': private
  /@inquirer/input/4.1.4(@types/node@22.12.0):
    '@inquirer/input': private
  /@inquirer/number/3.0.7(@types/node@22.12.0):
    '@inquirer/number': private
  /@inquirer/password/4.0.7(@types/node@22.12.0):
    '@inquirer/password': private
  /@inquirer/prompts/7.2.3(@types/node@22.12.0):
    '@inquirer/prompts': private
  /@inquirer/rawlist/4.0.7(@types/node@22.12.0):
    '@inquirer/rawlist': private
  /@inquirer/search/3.0.7(@types/node@22.12.0):
    '@inquirer/search': private
  /@inquirer/select/4.0.7(@types/node@22.12.0):
  ...
  /@nestjs/cli/11.0.0(@swc/cli@0.6.0)(@swc/core@1.10.7)(@types/node@22.12.0):
    '@nestjs/cli': private
  ...
  /cosmiconfig/8.3.6(typescript@5.7.3):
    cosmiconfig: private
  /create-jest/29.7.0(@types/node@22.12.0)(ts-node@10.9.2):
    create-jest: private
  ...
  /eslint-plugin-prettier/5.2.2(eslint-config-prettier@10.0.1)(eslint@9.19.0)(prettier@3.4.2):
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@22.12.0)(ts-node@10.9.2):
    jest-cli: private
  ...
  /jest-worker/29.7.0:
    jest-worker: private
  /jest/29.7.0(@types/node@22.12.0)(ts-node@10.9.2):
    jest: private
  /js-tokens/4.0.0:
    js-tokens: private
  /js-yaml/4.1.0:
  ...
  /ts-loader/9.5.2(typescript@5.7.3)(webpack@5.97.1):
    ts-loader: private
  /ts-node/10.9.2(@swc/core@1.10.7)(@types/node@22.12.0)(typescript@5.7.3):
    ts-node: private
